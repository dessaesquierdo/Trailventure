      ...
      <form action="">
        <div>
          ...
          <div className="relative my-4">
            ...
            <p className="flex items-center gap-1 mt-2 font-sans text-sm antialiased font-normal leading-normal text-red-200">
              <svg
        ...
        {/* Redirect to function that handles data entry input, then to Home screen full content */}
        <button
          type="submit"
